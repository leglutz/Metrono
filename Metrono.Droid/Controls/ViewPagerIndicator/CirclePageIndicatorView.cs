...
namespace DiodeCompany.Metrono.Droid.Controls.ViewPagerIndicator
{
    public class CirclePageIndicatorView : View, IPageIndicator
    {
        ...
        public CirclePageIndicatorView(Context context) : this(context, null)
        {
        }
        ...
        public CirclePageIndicatorView(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
            if (IsInEditMode)
            {
                return;
        ...
        public class CircleSavedState  : BaseSavedState
        {
            ...
            public CircleSavedState(IParcelable superState) : base(superState) { }

            private CircleSavedState(Parcel parcel) : base(parcel)
            {
