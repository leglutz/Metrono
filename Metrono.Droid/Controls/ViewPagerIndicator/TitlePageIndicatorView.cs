...
namespace DiodeCompany.Metrono.Droid.Controls.ViewPagerIndicator
{
    ...
    public class TitlePageIndicatorView : View, IPageIndicator
    {
        ...
        public TitlePageIndicatorView(Context context) : this(context, null)
        {
        }

        public TitlePageIndicatorView(Context context, IAttributeSet attrs) : this(context, attrs, Resource.Attribute.title_page_indicator_stlye)
        {
        }

        public TitlePageIndicatorView(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
            if(IsInEditMode)
            {
                return;
            ...
            var defaultFooterIndicatorStyle = res.GetInteger(Resource.Integer.default_title_indicator_footer_indicator_style);
            var defaultFooterIndicatorHeight = res.GetDimension(Resource.Dimension.default_title_indicator_footer_indicator_height);
            var defaultFooterIndicatorUnderlinePadding = res.GetDimension(Resource.Dimension.default_title_indicator_footer_indicator_underline_padding);
            ...
            var a = context.ObtainStyledAttributes(attrs, Resource.Styleable.TitlePageIndicatorView, defStyle, 0);

            _footerLineHeight = a.GetDimension(Resource.Styleable.TitlePageIndicatorView_footerLineHeight, defaultFooterLineHeight);
            _footerIndicatorStyle = (IndicatorStyle)a.GetInteger(Resource.Styleable.TitlePageIndicatorView_footerIndicatorStyle, defaultFooterIndicatorStyle);
            _footerIndicatorHeight = a.GetDimension(Resource.Styleable.TitlePageIndicatorView_footerIndicatorHeight, defaultFooterIndicatorHeight);
            _footerIndicatorUnderlinePadding = a.GetDimension(Resource.Styleable.TitlePageIndicatorView_footerIndicatorUnderlinePadding, defaultFooterIndicatorUnderlinePadding);
            _footerPadding = a.GetDimension(Resource.Styleable.TitlePageIndicatorView_footerPadding, defaultFooterPadding);
            _linePosition = (LinePosition)a.GetInteger(Resource.Styleable.TitlePageIndicatorView_linePosition, defaultLinePosition);
            _topPadding = a.GetDimension(Resource.Styleable.TitlePageIndicatorView_topPadding, defaultTopPadding);
            _titlePadding = a.GetDimension(Resource.Styleable.TitlePageIndicatorView_titlePadding, defaultTitlePadding);
            _clipPadding = a.GetDimension(Resource.Styleable.TitlePageIndicatorView_clipPadding, defaultClipPadding);
            _colorSelected = a.GetColor(Resource.Styleable.TitlePageIndicatorView_selectedColor, defaultSelectedColor);
            _colorText = a.GetColor(Resource.Styleable.TitlePageIndicatorView_android_textColor, defaultTextColor);
            _boldText = a.GetBoolean(Resource.Styleable.TitlePageIndicatorView_selectedBold, defaultSelectedBold);

            var textSize = a.GetDimension(Resource.Styleable.TitlePageIndicatorView_android_textSize, defaultTextSize);
            var footerColor = a.GetColor(Resource.Styleable.TitlePageIndicatorView_footerColor, defaultFooterColor);
            ...
            var background = a.GetDrawable(Resource.Styleable.TitlePageIndicatorView_android_background);
            if(null != background)
            {
        ...
        public class TitleSavedState : BaseSavedState
        {
            ...
            public TitleSavedState(IParcelable superState) : base(superState)
            {
            }

            private TitleSavedState(Parcel parcel) : base(parcel)
            {
